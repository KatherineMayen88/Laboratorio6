...
class Orden
{
    ...
    public:
        //QUICKSORT DE NOMBRES 
        listadoPokemons* startQuickSort(listadoPokemons Info[], int menor, int mayor)
        {
            QuickSort(Info, menor, mayor);
            return Info;
        }

        void QuickSort(listadoPokemons Info[], int menor, int mayor)
        {
            if (menor < mayor)
            {
        ...
        void swap(listadoPokemons* a, listadoPokemons* b)
        {
            listadoPokemons t = *a;
            *a = *b;
            *b = t;
        ...
        int QuickSortPartition(listadoPokemons Info[], int mayor, int menor)
        {
        ...
        //SELECTION SORT DE GENERACION Y NATIONAL NUMBER
        listadoPokemons* SelectionSort(listadoPokemons Info[], int mayor, int menor)
        {
        ...
        //SHELL SORT 
        listadoPokemons* ShellSort(listadoPokemons Info[], int mayor, int menor)
        {
        ...
        listadoPokemons* Almacenar()
        {
            static listadoPokemons Info[200];
            int conteo = 0;
